...
namespace HoloToolkit.Unity.UX
{
    ...
    {
        [Header("Flattening")]
        //[SerializeField] MaquinaIndustrial maquinaIndustrial;
        [SerializeField]
        ...
        public Vector3 scaleHandleSize = new Vector3(0.02f, 0.02f, 0.02f);//tamanho das bordas de scale

        public Vector3 rotateHandleSize = new Vector3(0.02f, 0.02f, 0.02f);//tamanho das bordas de rotation
        ...
        }//ativa as opções de escala e rotação

        public void Deactivate()
        {
            InputManager.Instance.RaiseBoundingBoxRigDeactivated(gameObject);
            ShowRig = false;
        }//desativa as opções de escala e rotação
        ...
        public void Start() // instancia objetos
        {
        ...
        public void UpdateBoundsPoints()
        {
        ...
        public void UpdateCornerHandles()
        {
        ...
        }//alguma coisa com scale

        public void UpdateRotateHandles()
        {
        ...
        public void ClearCornerHandles()
        {
        ...
        public void ClearRotateHandles()
        {
        ...
        }//destroi rotação e scale

        public GameObject BuildRig()
        {
        ...
        }//mostra o rig partes principal de sacle e ratation
        ...
        public List<Vector3> GetBounds()
        {
            ...
            if (objectToBound != null)
            {
                ...
                GameObject clone = GameObject.Instantiate(boxInstance.gameObject);//instancia gameobject
